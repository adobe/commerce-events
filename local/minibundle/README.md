...
For UMD builds, minibundle will use a camelCase version of the `name` field in your `package.json` as export name.
...
Minibundle is able to detect and bundle Module Workers when generating bundles in the
