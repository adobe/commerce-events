...
const createShoppingCartItems = (shoppingCart?: ShoppingCart) => {
    ...
    const shoppingCartItems: Array<ShoppingCartItem> = shoppingCartCtx.items.map<ShoppingCartItem>((item) => ({
...
const createContext = (shoppingCart?: ShoppingCart): ShoppingCartContext | null => {
    ...
    const context: ShoppingCartContext = {
        ...
        data: {
            ...
            subtotalExcludingTax: shoppingCartCtx.prices?.subtotalExcludingTax?.value,
            subtotalIncludingTax: shoppingCartCtx.prices?.subtotalIncludingTax?.value,
